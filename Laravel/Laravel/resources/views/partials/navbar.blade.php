...
<nav class="navbar">
    ...
    <ul class="navbar-menu">
        ...
        <li><a href="{{ route('penyewa') }}" class="{{ request()->routeIs('penyewa') ? 'active' : '' }}">Penyewa</a>
        </li>
        <li><a
                href="{{ route('manajemen-mahasiswa.index') }}"class="{{ request()->is('manajemen-mahasiswa*') ? 'active' : '' }}">Manajemen
                Mahasiswa</a></li>
